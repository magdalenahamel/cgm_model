...
def get_spec_tpcf(theta_max,theta_min,r_0,size,vel, zmax, sample_size = 100):
    alphas = np.random.uniform(low=-90, high=-45, size=(100,))
    ds = np.random.uniform(low=1, high=100, size=(100,))
    inclis = np.random.uniform(low=70, high=89, size=(100,))
    
    partial_params = [[ds[i], alphas[i], inclis[i]] for i in range(100)]
