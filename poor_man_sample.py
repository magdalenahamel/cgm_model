...
bs = np.logspace(1,0.01,7) # characteristic radius of the exponential function (it is accually a porcentage of Rvir) in log scale to make the range more homogeneous in lin scale
csize = np.linspace(0.1,10,7) #poner en escala mas separada
hs = np.linspace(1,20,7) #bajar un poco para que no sea un  1,10,20
hv = np.linspace(0, 100,7) #bajar maximo a 100
